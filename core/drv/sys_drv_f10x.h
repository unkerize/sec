//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
#ifndef _HK_SYS_DRV_10X_H
#define _HK_SYS_DRV_10X_H
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
//#include "sys_drv_10x_chips.h"
...
// _HSE_PLL_DIV (PREDIV1)
  ...
  #if (_HSE_PLL_DIV < 1) || (_HSE_PLL_DIV > 2)
    #error "_HSE_PLL_DIV out of range"
  #endif
...
#define _PLL_MUL_MASK ( (_PLL_MUL-2)*RCC_CFGR_PLLMULL_0 )
//------------------------------------------------------------
// _CLK_AHB_DIV
#ifndef _CLK_AHB_DIV
